...
import themoviedb.composeapp.generated.resources.airing_today_category
import themoviedb.composeapp.generated.resources.on_tv_category
import themoviedb.composeapp.generated.resources.popular_category
import themoviedb.composeapp.generated.resources.top_rated_category
...
fun HomeScreenPreview() {
    TmdbTheme {
        ...
        val categories = listOf(
            CategoryModel(Res.string.top_rated_category, Constants.TOP_RATED),
            CategoryModel(Res.string.popular_category, POPULAR),
            CategoryModel(Res.string.on_tv_category, Constants.ON_THE_AIR),
            CategoryModel(Res.string.airing_today_category, Constants.AIRING_TODAY)
        )
        HomeScreen(
            uiState = State(
