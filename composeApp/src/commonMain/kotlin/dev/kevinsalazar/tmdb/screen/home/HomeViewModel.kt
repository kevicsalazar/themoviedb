...
class HomeViewModel(
    ...
    private fun onGetCategories() {
        val categories = listOf(
            CategoryModel(Res.string.top_rated_category, TOP_RATED),
            CategoryModel(Res.string.popular_category, POPULAR),
            CategoryModel(Res.string.on_tv_category, ON_THE_AIR),
            CategoryModel(Res.string.airing_today_category, AIRING_TODAY)
        )
        _state.update {
